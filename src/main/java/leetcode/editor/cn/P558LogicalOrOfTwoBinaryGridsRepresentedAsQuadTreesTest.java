...
// n == 2^x ，其中 0 <= x <= 9. 
// 
// Related Topics 树 分治 👍 30 👎 0

package leetcode.editor.cn;

import org.junit.jupiter.api.Test;

class P558LogicalOrOfTwoBinaryGridsRepresentedAsQuadTreesTest {
    @Test
    public void solutionTest() {
        Solution solution = new P558LogicalOrOfTwoBinaryGridsRepresentedAsQuadTreesTest().new Solution();
        //TO TEST
    }
