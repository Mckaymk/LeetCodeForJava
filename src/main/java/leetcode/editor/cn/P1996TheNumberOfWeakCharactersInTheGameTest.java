...
// 
// Related Topics 栈 贪心 数组 排序 单调栈 👍 54 👎 0

package leetcode.editor.cn;

import org.junit.jupiter.api.Test;

class P1996TheNumberOfWeakCharactersInTheGameTest {
    @Test
    public void solutionTest() {
        Solution solution = new P1996TheNumberOfWeakCharactersInTheGameTest().new Solution();
        //TO TEST
    }
