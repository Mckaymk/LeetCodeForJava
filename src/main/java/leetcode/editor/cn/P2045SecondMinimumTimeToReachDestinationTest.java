...
// 1 <= time, change <= 10³ 
// 
// Related Topics 广度优先搜索 图 最短路 👍 44 👎 0

package leetcode.editor.cn;

import org.junit.jupiter.api.Test;

class P2045SecondMinimumTimeToReachDestinationTest {
    @Test
    public void solutionTest() {
        Solution solution = new P2045SecondMinimumTimeToReachDestinationTest().new Solution();
        //TO TEST
    }
